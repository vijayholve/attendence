...
fro_css.replace('{{ student_image }}', student_image_url)
...
def download_id_card(request, student_id):
    ...
    # Add image handling
    student_image_url = request.build_absolute_uri(student.profile) if student.profile else ''
    html_with_css = html_with
