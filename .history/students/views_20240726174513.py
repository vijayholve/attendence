...
def teacher_list(request):
    ...
    if isinstance(user, CustomUser):    
        usencustomuserame = user.username
    ...
    content={'student_attendance': student_attendance,"today":today ,'user':user ,
             'user_type':user_type} 
    return render(request, 'students/hii.html', content) #change the page path
