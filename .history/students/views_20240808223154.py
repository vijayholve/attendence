...
def export_data_dowload(request,class_id):
    ...
    try:
        ...
        .stdout.write(.style.SUCCESS(f'Successfully exported attendance data to {file_path}'))

    except Exception as e:
        .stdout.write(.style.ERROR(f'Error exporting attendance data: {e}'))
