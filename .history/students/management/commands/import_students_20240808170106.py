...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        Fake=Faker()
        file_path = rf""C:\Users\Vijay\python pro\attendance\students\management\data\attendance_data.xlsx""
        classgroup=ClassGroup.objects.get(name__name="BCS",year="SY")
        try:
