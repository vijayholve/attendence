...
def assignments_checking(request,class_id):
    ...
    for student in students:
        assignements_exists = Assignment.objects.filter(
            students=students).exists()
        student_assignment.append((student, assignements_exists))
    content={"student_assignment":student_assignment}
    return render(request,rf"assignements\check_assignement.html",content)
