...
def assignments_checking(request,class_id):
    ...
    for student in students:
        attendance_exists = Assignment.objects.filter(
            students=students).exists()
        student_assignment.append((student, attendance_exists))
    return render(request,"C:\Users\Vijay\python pro\attendance\templates\assignements\check_assignement.html")
